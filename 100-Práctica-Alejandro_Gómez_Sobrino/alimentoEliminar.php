...
<?php if ($correcto) { ?>
	...
	<p>Se ha eliminado correctamente el alimento.</p>

<?php } else if ($noExistia) { ?>

	<h1>Eliminación imposible</h1>
	<p>No existe el alimento que se pretende eliminar.</p>

<?php } else { ?>

	<h1>Error en la eliminación</h1>
	<p>No se ha podido eliminar el alimento o el alimento no existía.</p>

<?php } ?>

<a href='alimentoListado.php'>Volver al listado de alimentos.</a>
